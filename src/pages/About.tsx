...
/** A narcissistic page about myself. */
export default function About() {
	return <>
		...
		<p>I've been programming ever since, and now attend the <ExternalA href="https://johnabbott.qc.ca/career-programs/computer-science-technology/">Computer Science Technology program at John Abbott College</ExternalA>. Though the passion for making my own games lives on, I've come to adore the diverse challenges programming offers and the people I've gotten to share them with. I love participating in programming competitions, and I tutor people in the hopes of being surpassed by them some day.</p>
