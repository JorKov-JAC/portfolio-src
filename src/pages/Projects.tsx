...
const projects: ProjectEntry[] = [
	...
	},
	{
		...
		medium: "TypeScript",
		process: () => <>
			<p>For my final Game Development project, I chose to make an RTS inspired by StarCraft. This was done solo and without using any starter code, meaning I had to write an entire engine in TypeScript. The project took 3.5 days and totalled approximately 3.5k lines of raw code at time of submission. I had never made an RTS before and saw this an opportunity to challenge myself. Building a comprehensive engine from the ground up, including UI and saving systems, gave me a holistic appreciation for game engine design. Click "View Online" above for more details.</p>
		</>
	},
	{
		...
		process: () => <>
			<p>In my second semester in the computer science program, our final UI project required that we make a simple JavaScript game to prove that we could add interactivity to sites made in WordPress. As I was already deeply comfortable with JavaScript, I decided to make my first ever proper 3D game. I derived all of the math involved in an attempt to strengthen my vector math knowledge (deriving the transformation matrices proved to be a nightmare). This was also my first experience with OpenGL/WebGL, as well as with GLSL. I gained a great understanding of the way the OpenGL state machine works, the way information is exchanged with the GPU, and the way shaders and buffers are setup to generate graphics. Click "View Online" above for more details.</p>
		</>
	},
	{
		name: "GPU Particles",
		...
		process: () => <>
			<p>Having previously made 3D graphics in WebGL, I wanted to experiment with running computations on the GPU, and doing so while limiting myself to purely graphical processing. This personal project illustrates how older GPU calculations were done, with data being stored as pixels in a texture, and shaders "drawing" their calculations into another texture, and was excellent practice for both shader programming and low-level OpenGL computation techniques. Click "View Online" above for more details.</p>
		</>
	},
	{
